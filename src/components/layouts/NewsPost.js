            ...
            <div className="row">
                ...
                <div className="news-post-wrapper">
                    ...
                    <div className="text-center">
                        <Link to="#" className="btn btn-dark font-weight-bold mb-4">News</Link>
                    </div>
                    <p
                        className="fs-15 d-flex justify-content-center align-items-center m-0"
                    >
                        <img
                    ...
                    <h1 className="font-weight-600 text-center mb-5">
                        You may also like
                    </h1>
